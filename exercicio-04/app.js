...
*/
const my3FavoriteTVShows = ['Naruto' , 'Lista Negra', 'The Flash'];
...
*/
const num = 39;
// console.log(`A string que a "typeSentence" armazena tem mais de ${num} caracteres? ${String(typeSentence.length > num).replace('t','T') }.`);
