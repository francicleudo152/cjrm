...
let regadormessagem = best2019Movie => {
   mensagem += ` 
   - ${best2019Movie.title}, dirigido por ${best2019Movie.directedBy}`
  }

best2019Movies.forEach(regadormessagem);
...
const youtubeUser = {
  ...
  videosRecentes: function() {
    console.log(`Vídeos recentes de ${this.name}:`)
    this.videos.recentVideos.forEach(recent => {
        return console.log(recent.title)

    })
  }
}

youtubeUser.videosRecentes();
...
document.write(Math.round(numero * 10))