...
*/
// brazilianFoods.push('Coxinha',null,'Briagdeiro');
brazilianFoods=['Coxinha',null,'Briagdeiro'];
...
*/
const dessert = `${dogNames[0].slice(3,6)+dogNames[1].slice(2,4)+dogNames[3].slice(2,4).replace('n','d')}`;
