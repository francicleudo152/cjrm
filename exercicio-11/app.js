...
*/
  ...
  // A variavel let "idade" foi criado apenas dentro bloco não é uma vaviavel global.
...
let car = {
  ...
  getColorsMessage: function(){
      const ultimoItem = this.color[this.color.length -1];
      const color = this.color.join(', ').replace(ultimoItem, `e ${ultimoItem}`)
...
*/
  console.log(`"O carro é um ${car['band']} ${car['name']}"`);